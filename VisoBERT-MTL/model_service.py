...
class ModelService:
    ...
    def _find_config_path(self):
        ...
        possible_paths = [
            os.path.join(current_dir, 'config_multi.yaml'),  # Trong dual-task-learning/
            os.path.join(os.path.dirname(current_dir), 'dual-task-learning', 'config_multi.yaml'),  # Từ root
            'dual-task-learning/config_multi.yaml',  # Relative từ root
