...
class ErrorAnalyzer:
    ...
    def load_data(self):
        ...
        print(f"NOTE: Includes all labeled aspects (positive/negative/neutral), excludes only unlabeled")
    ...
    def create_visualizations(self, aspect_stats_df, sentiment_stats_df, cm):
        ...
        if cm.shape != (3, 3):
            print(f"WARNING: Confusion matrix shape is {cm.shape}, expected (3, 3)")
    ...
    def generate_report(self):
        ...
        report_lines.extend([
            ...
            "",
            "NOTE: Includes all labeled aspects (positive/negative/neutral)",
    ...
    def run_full_analysis(self):
        ...
        print(f"\nLƯU Ý: Chỉ tính trên LABELED ASPECTS (positive/negative/neutral)")
